...
Here, "entity" could be a single person, a corporation, or a government. However, it does not include an organisation that operates in a manner that effectively mitigates centralisation (see, e.g., {{multi}}).
