...
While maintaining these properties remains a widely shared goal for the Internet, consistently achieving them has proven more difficult over time. Today, many successful Internet services operate in a centralized fashion -- to the point where some proprietary applications have become so well-known that they are commonly mistaken for the Internet itself. Even when open protocols incorporate techniques intended to prevent consolidation, economic and social factors can drive users to prefer solutions built with or on top of supposedly decentralized technology.
