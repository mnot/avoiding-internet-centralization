...
This definition of centralization focuses largely upon the people who have influence upon or access to a function. While centralization is also a concern from a purely technical standpoint, this more political focus deserves specific and separate treatment. A single entity can operate a technically decentralized system (and often does; for example, most cloud services are designed in this way).
