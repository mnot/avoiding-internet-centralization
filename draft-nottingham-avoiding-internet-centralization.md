...
While maintaining these properties remains a widely shared goal, consistently achieving them has proven more difficult over time. Today, many successful services operate in a centralized fashion -- to the point where some proprietary applications have become so well-known that they are commonly mistaken for the Internet itself. {{FB-INTERNET}} Even when open protocols purposefully incorporate decentralization techniques, economic and social factors can result in centralization.
